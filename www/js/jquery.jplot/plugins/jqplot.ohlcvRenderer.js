...
(function($) {
    /**
     * Class: $.jqplot.OHLCVRenderer
     * jqPlot Plugin to draw Open Hi Low Close, Candlestick and Hi Low Close charts.
     * 
     * To use this plugin, include the renderer js file in 
     * your source:
     * 
     * > <script type="text/javascript" src="plugins/jqplot.ohlcvRenderer.js"></script>
     * 
     ...
     * 
     * > series: [{renderer:$.jqplot.OHLCVRenderer}]
     * 
     * For OHLCV and candlestick charts, data should be specified
     * like so:
     * 
     * > dat = [['07/06/2009',138.7,139.68,135.18,135.4, 500], ['06/29/2009',143.46,144.66,139.79,140.02, 300], ...]
     * 
     ...
     * 
     * To generate a candlestick chart instead of an OHLCV chart,
     * set the "candlestick" option to true:
     * 
     * > series: [{renderer:$.jqplot.OHLCVRenderer, rendererOptions:{candleStick:true}}],
     * 
     */
    $.jqplot.OHLCVRenderer = function(){
    ...
    $.jqplot.OHLCVRenderer.prototype = new $.jqplot.LineRenderer();
    $.jqplot.OHLCVRenderer.prototype.constructor = $.jqplot.OHLCVRenderer;
    
    // called with scope of series.
    $.jqplot.OHLCVRenderer.prototype.init = function(options) {
        options = options || {};
    ...
    $.jqplot.OHLCVRenderer.prototype.draw = function(ctx, gd, options) {
        var d = this.data;
        ...
        ctx.save();
        if (this.show) {
            var x, open, hi, low, close, volume;
    ...
    $.jqplot.OHLCVRenderer.prototype.drawShadow = function(ctx, gd, options) {
        // This is a no-op, shadows drawn with lines.
    };
    
    // called with scope of plot.
    $.jqplot.OHLCVRenderer.checkOptions = function(target, data, options) {
    ...
    //$.jqplot.preInitHooks.push($.jqplot.OHLCVRenderer.checkOptions);
